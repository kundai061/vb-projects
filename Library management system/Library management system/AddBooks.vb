    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Else
            Try
                ...
                com = New OleDb.OleDbCommand("INSERT INTO Books VALUES('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & ComboBox2.Text & "','" & TextBox5.Text & "','" & ComboBox3.Text & "')", objcon)
                com.ExecuteNonQuery()
                Call readData()
            ...
            Else
                For i = 0 To ListView1.Items.Count - 1
                    If TextBox1.Text = ListView1.Items(i).SubItems(0).Text Then
                        ...
                        ComboBox2.Text = ListView1.Items(i).SubItems(4).Text
                        TextBox5.Text = ListView1.Items(i).SubItems(5).Text
                        ComboBox3.Text = ListView1.Items(i).SubItems(6).Text
