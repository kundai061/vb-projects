Public Class StudentDetail
    ...
    Sub readDataW()
        ...
        ListView1.Columns.Add("STUDENT NAME", 140, HorizontalAlignment.Center)
    ...
    Sub readData()
        ...
        End Try
    End Sub
    Public Sub adddatatolistview(ByVal lvw As ListView, ByVal CID As String, ByVal CName As String, ByVal CCont As String)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Try
                ...
                If (objcon.State = ConnectionState.Closed) Then objcon.Open()
                com = New OleDb.OleDbCommand("SELECT * FROM Student WHERE CID='" & TextBox1.Text & "'", objcon)
                dr = com.ExecuteReader
                While dr.Read()
                    Call adddatatolistview(ListView1, dr(0), dr(1), dr(2))
                End While
